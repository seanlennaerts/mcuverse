...
import * as Eternals from './Eternals.json';
import * as IAntMan from './1 Ant-Man.json';
import * as IAvengers from './1 Avengers.json';
import * as IBlackPanther from './1 Black Panther.json';
import * as ICaptainAmerica from './1 Captain America.json';
import * as IDoctorStrange from './1 Doctor Strange.json';
...
import * as IIBlackPanther from './2 Black Panther.json';
import * as IICaptainAmerica from './2 Captain America.json';
import * as IIDoctorStrange from './2 Doctor Strange.json';
...
import * as IIIAntMan from './3 Ant-Man.json';
...
import * as IIISpiderMan from './3 Spider-Man.json';
import * as IIIThor from './3 Thor.json';
import * as IVAvengers from './4 Avengers.json';
import * as IVThor from './4 Thor.json';
import * as ShangChi from './Shang-Chi.json';
